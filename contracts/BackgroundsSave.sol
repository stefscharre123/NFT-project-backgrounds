...
contract Backgrounds2 is ERC721, ERC721URIStorage, Ownable {
    ...
    constructor(string memory _initialBaseURI, bytes32 _root)
    ...
    function setIsWhitelistMintActive(bool _statusWhitelistMint) public onlyOwner {
        isWhitelistMintActive = _statusWhitelistMint;
    }

    function setIsPublicMintActive(bool _statusPublicMint) public onlyOwner {
        isPublicMintActive = _statusPublicMint;
    ...
    function whitelistMint(bytes32[] calldata proof) public payable {
        require(isWhitelistMintActive, "Whitelist mint is not open");
    ...
    function publicMint(uint256 amount) public payable {
        require(isPublicMintActive, "Public mint is not open");
